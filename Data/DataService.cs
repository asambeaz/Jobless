...
namespace Jobless.Data
{
    public class DataService
    {
        ...
        public static long AddCompany(string name, string password, int numberOfActivePostings)
        {
            MySqlConnection mySqlConnection = DataBase.GetConnection();
            mySqlConnection.Open();
        ...
        public static List<JobPosting> GetJobPostings()
        {
            ...
            using (mySqlConnection)
            {
                ...
                while (reader.Read())
                {
                    ...
                    jobPosting.IsActive = reader.GetBoolean(4);
        ...
        public static void AddJobPosting(int companyId, string proffesion, string description, bool isActive)
        {
            MySqlConnection mySqlConnection = DataBase.GetConnection();
            mySqlConnection.Open();
            ...
            using (mySqlConnection)
            {
                string sql = "INSERT INTO job_postings(company_id, proffesion, description, is_active) " +
                                "VALUES (@company_id, @proffesion, @description, @is_active)";
                MySqlCommand command = new MySqlCommand(sql, mySqlConnection);
        ...
        public static void EditJobPosting(int id, bool isActive)
        {
            MySqlConnection mySqlConnection = DataBase.GetConnection();
            mySqlConnection.Open();
            ...
            using (mySqlConnection)
            {
                string sql = "UPDATE job_postings " +
